...
public class CloudEndpointUtils {
   ...
   * information.
   */
  protected static final boolean LOCAL_ANDROID_RUN = false; //FIXME server

  /*
   * The root URL of where your DevAppServer is running (if you're running the
   * DevAppServer locally).
   */
  protected static final String LOCAL_APP_ENGINE_SERVER_URL = "http://" + Collectendpoint.LOCAL_DEFAULT_IP;
   ...
   */
  protected static final String LOCAL_APP_ENGINE_SERVER_URL_FOR_ANDROID = "http://" + Collectendpoint.LOCAL_DEFAULT_IP;
